...
function initKeyboardShortcuts() {
    ...
    if (toggleBtn) {
        toggleBtn.addEventListener('click', toggleShortcutsModal);
    }
    
    // Close buttons
    const closeBtn = document.getElementById('shortcutsModalClose');
    const closeBtn2 = document.getElementById('shortcutsModalCloseBtn');
    
    if (closeBtn) {
        closeBtn.addEventListener('click', closeShortcutsModal);
    }
    if (closeBtn2) {
        closeBtn2.addEventListener('click', closeShortcutsModal);
    }
