...
function kmpPrev() { if (kmpState.stepIndex <= 1) { kmpState.stepIndex = 0; kmpResetRender(); return; } const target = kmpState.stepIndex - 2; kmpResetRender(); kmpState.stepIndex = 0; for (let idx = 0; idx <= target; idx += 1) { kmpApplyStep(kmpState.steps[idx]); kmpState.stepIndex = idx + 1; } }
